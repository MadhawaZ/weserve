...
CREATE TABLE `sub_service` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_sub_service_idx` (`main_service_id`),
  CONSTRAINT `fk_sub_service` FOREIGN KEY (`main_service_id`) REFERENCES `main_service` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `sub_service` VALUES (1,'Technician',NULL,1),(2,'Motor Mechanics',NULL,1),(3,'Human',NULL,2),(4,'Animal',NULL,2);
