    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <div class="icon"><i class="fa fa-clock-o fa-2x fa-fw"></i></div>
        <div class="stats_info">
            ...
            <h4>11/09/2017<br>05:48:59 AM</h4>
    ...
    <div class="container-fluid">
      ...
      <form>
          ...
          <div class="form-group"  >
            <label for="exampleInputEmail1">Service Type  <select name="Service types">
            ...
            <input class="form-control" id="exampleInputType" type="text"  >
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputServiceID" type="text" placeholder="Service ID">
          </div>
          <div class="form-group">
